...
public class VentanaAhorcado extends javax.swing.JFrame {
    ...
    public VentanaAhorcado() {
        initComponents();
        //nada mas empezar el juego viene aqui, se mete en el eligePalabra y elige una palabr random
      ...
      for (int i=0; i < palabraOculta.length(); i++){
          if (palabraOculta.charAt(i) == letraPulsada){
              palabraConGuiones = 
                      ...
                      + letra 
                      + palabraConGuiones.substring(2*i+1); //el trozo de la izquierda de la letra
              acierto = true;
          }
      }
  ...
  private void dibujaImagen (int numeroFallos){
    ...
    private String eligePalabra(){
        //este metodo elegira una palabra al azar de una lista de palabras 
        //la lista de palabras la vamos a guardar en un array
        
        String [] listaPalabras = {"HELLO", "BELLACIAO", "YOUHAVEBEENBANED","ALLAHUAKBAR"};
